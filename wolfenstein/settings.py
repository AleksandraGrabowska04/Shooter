...
# PLAYER_POS = glm.vec3(8.5, PLAYER_HEIGHT, 8.5)

# gesture control tuning
GESTURE_MOVE_SCALE = 1.0
GESTURE_TURN_SCALE = 0.5
GESTURE_MOVE_DEADZONE = 0.06
GESTURE_ACTION_THRESHOLD = 0.35
GESTURE_ACTION_COOLDOWN = 0.6
