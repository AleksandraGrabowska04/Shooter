...
class NPC(GameObject):
    ...
    def move_to_player(self):
        if self.path_to_player[0] == None:
            return None

        # set state
        self.set_state(state='walk')

        # print(type(self.path_to_player))

        # step to player
        dir_vec = glm.normalize(glm.vec2(self.path_to_player[0], self.path_to_player[1]) + H_WALL_SIZE - self.pos.xz)
