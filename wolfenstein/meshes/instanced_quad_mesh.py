...
# instancing technique allows you to draw multiple objects with the same mesh in one draw call
    ...
    def get_vao(self):
        ...
        vao = self.ctx.vertex_array(
            ...
            [
                ...
                (self.m_model_vbo, '4f 4f 4f 4f /i',
                 'm_model_0', 'm_model_1', 'm_model_2', 'm_model_3'),
